...
input TradeSignalTypeEnum __time_indicator_0_signal_type_2 = TradeSignalTypeEnum::CLOSE_BUY_MARKET;                        // #3 Trade signal type
input TimeIndicatorSignalsEnum __time_indicator_0_signal_trigger_2 = TimeIndicatorSignalsEnum::CURRENT_HOUR_IS_CLOSE_HOUR; // #3 Trade signal trigger
input TradeSignalTypeEnum __time_indicator_0_signal_type_3 = TradeSignalTypeEnum::CLOSE_BUY_MARKET;                        // #4 Trade signal type
input TimeIndicatorSignalsEnum __time_indicator_0_signal_trigger_3 = TimeIndicatorSignalsEnum::CURRENT_HOUR_IS_CLOSE_HOUR; // #4 Trade signal trigger