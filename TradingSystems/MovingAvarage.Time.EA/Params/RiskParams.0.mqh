...
input ENUM_TIMEFRAMES __risk_manager_0_drawdown_limit_period_0 = PERIOD_D1;                                     // #1 Drawdown limit period
input double __risk_manager_0_drawdown_limit_percent_0 = 4.5;                                                   // #1 Drawdown limit balance percentage
input ENUM_TIMEFRAMES __risk_manager_0_drawdown_limit_period_1 = PERIOD_H1;                                     // #2 Drawdown limit period
input double __risk_manager_0_drawdown_limit_percent_1 = 1.0;                                                   // #2 Drawdown limit balance percentage
