...
input bool __risk_manager_consume_all_calculated_lots = false;                                                                       // Allow to open as many position as needed by calculated lots
...
input double __risk_manager_size_value_or_balance_percentage_short = 1;                                                              // #2 Drawdown limit balance percentage
